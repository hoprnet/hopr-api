# hopr-lib API Development Guidelines

## Project Overview

hopr-lib API is a trait-only library that defines the public API surface for the HOPR protocol. It provides high-level API traits across six domains: chain interactions, cover traffic, database, network graphs, network state, and node control.
