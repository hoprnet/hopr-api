...
pub enum PixEvent {
    ...
    ///
    /// This notifies the Entry node to make a deposit to the address.
    ///
    ...
    DepositAddressReceived(PixAddressId, Address, Option<DepositUpdated>),
    /// The Exit has recovered the private key for a deposit address.
    ///
    /// Generated on the Exit node only.
    PrivateKeyRecovered(PixAddressId, ChainKeypair),
}
