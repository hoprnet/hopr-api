...
pub enum PixEvent {
    ...
    NewDepositAddress(PixAddressId, PixDepositAddress, u64),
    ...
    DepositAddressReceived(PixAddressId, PixDepositAddress, u64, Option<DepositUpdated>),
    /// The Exit has recovered the private key for a deposit address.
    ///
    /// Generated on the Exit node only.
    PrivateKeyRecovered(PixAddressId, PixDepositSecret),
}
